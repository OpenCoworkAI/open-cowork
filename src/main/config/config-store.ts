...
export class ConfigStore {
  ...
  private normalizeConfig(rawConfig: Partial<AppConfig> | undefined): AppConfig {
    ...
    return {
      ...
      workEnvironment: (raw.workEnvironment === 'real-machine' || raw.workEnvironment === 'vm') ? raw.workEnvironment : defaultConfig.workEnvironment,
      workEnvironmentVersion: typeof raw.workEnvironmentVersion === 'number' ? raw.workEnvironmentVersion : defaultConfig.workEnvironmentVersion,
    };
  }
